...
import { productEditRoute } from '@/lib/routes';
...
export function ProductActions({
  ...
  product: ProductDto;
  /** Recarrega o detalhe: sem servidor, `router.refresh()` nao busca dados. */
  onChanged: () => void;
}) {
  ...
  return (
    <div className="flex shrink-0 gap-2">
      <Button variant="secondary" onClick={() => router.push(productEditRoute(product.id))}>
      ...
      <Dialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              O produto sai das listagens, mas o historico e mantido. Voce pode reativa-lo quando
              quiser.
            </DialogDescription>
          </DialogHeader>

          <DialogFooter>
            <Button variant="secondary" onClick={() => setConfirmOpen(false)} disabled={working}>
              Cancelar
            </Button>
