...
import type { DashboardMetricsDto, ProductDto } from '@hub/shared';
...
/**
 * Visao com dados reais.
 *
 * A ordem da pagina segue a pergunta que a pessoa traz ao abrir o sistema:
 * primeiro "como esta minha operacao?" (metricas), depois "o que fiz por
 * ultimo?" e so entao "o que falta configurar?". Indicadores de venda e
 * financeiro chegam junto com seus modulos, e nao como caixas zeradas.
 */
export function DashboardOverview({
  ...
  const showChecklist = pendingSteps.length > 0 || setup.steps.some((step) => !step.available);
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_320px]">
        <section className="rounded-xl border border-line bg-surface">
          <div className="flex items-center justify-between gap-3 border-b border-line px-5 py-4">
            <h2 className="text-sm font-semibold text-foreground">Ultimos produtos cadastrados</h2>
            <Link
              href="/products"
